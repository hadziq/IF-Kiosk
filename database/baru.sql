...
-- Jalankan setelah ruangan_kelas sudah terisi.
-- ============================================================

INSERT INTO jadwal (ruangan_kelas_id, hari, jam_mulai, jam_selesai, mata_kuliah)
  SELECT id, 'Senin', '10:00:00', '12:50:00', 'IF_Teknik Peramalan T'
  FROM ruangan_kelas WHERE nama_ruang = 'IF_101';
...
INSERT INTO jadwal (ruangan_kelas_id, hari, jam_mulai, jam_selesai, mata_kuliah)
  ...
  FROM ruangan_kelas WHERE nama_ruang = 'IF_102';
...
INSERT INTO jadwal (ruangan_kelas_id, hari, jam_mulai, jam_selesai, mata_kuliah)
  SELECT id, 'Jumat', '09:00:00', '11:50:00', 'RKA_Probabilitas dan Statistik N'
  FROM ruangan_kelas WHERE nama_ruang = 'IF_102';

INSERT INTO jadwal (ruangan_kelas_id, hari, jam_mulai, jam_selesai, mata_kuliah)
  SELECT id, 'Senin', '07:00:00', '09:50:00', 'IUP_Perancangan Perangkat Lunak IUP I'
  FROM ruangan_kelas WHERE nama_ruang = 'IF_103';
...
INSERT INTO jadwal (ruangan_kelas_id, hari, jam_mulai, jam_selesai, mata_kuliah)
  SELECT id, 'Jumat', '13:30:00', '16:20:00', 'Pengantar Logikda dan Pemrograman Z'
  FROM ruangan_kelas WHERE nama_ruang = 'IF_103';

INSERT INTO jadwal (ruangan_kelas_id, hari, jam_mulai, jam_selesai, mata_kuliah)
  SELECT id, 'Senin', '07:00:00', '09:50:00', 'RKA_Struktur Data N'
  FROM ruangan_kelas WHERE nama_ruang = 'IF_104';
...
INSERT INTO jadwal (ruangan_kelas_id, hari, jam_mulai, jam_selesai, mata_kuliah)
  SELECT id, 'Jumat', '13:30:00', '16:20:00', 'Game Engine T'
  FROM ruangan_kelas WHERE nama_ruang = 'IF_104';

INSERT INTO jadwal (ruangan_kelas_id, hari, jam_mulai, jam_selesai, mata_kuliah)
  SELECT id, 'Senin', '07:00:00', '09:50:00', 'IF_Pengantar Teknologi Elektro dan Informatika Cerdas C'
  FROM ruangan_kelas WHERE nama_ruang = 'IF_105';
...
INSERT INTO jadwal (ruangan_kelas_id, hari, jam_mulai, jam_selesai, mata_kuliah)
  SELECT id, 'Jumat', '13:30:00', '16:20:00', 'IF_Komputasi Numerik F'
  FROM ruangan_kelas WHERE nama_ruang = 'IF_105';

INSERT INTO jadwal (ruangan_kelas_id, hari, jam_mulai, jam_selesai, mata_kuliah)
  SELECT id, 'Senin', '07:00:00', '09:50:00', 'S3_Filsafat Ilmu A'
  FROM ruangan_kelas WHERE nama_ruang = 'IF_106';
...
INSERT INTO jadwal (ruangan_kelas_id, hari, jam_mulai, jam_selesai, mata_kuliah)
  SELECT id, 'Jumat', '09:00:00', '11:50:00', 'S3_Topik Dalam Data Multivariat'
  FROM ruangan_kelas WHERE nama_ruang = 'IF_106';

INSERT INTO jadwal (ruangan_kelas_id, hari, jam_mulai, jam_selesai, mata_kuliah)
  SELECT id, 'Jumat', '13:30:00', '16:20:00', 'S3_TD IMK'
  FROM ruangan_kelas WHERE nama_ruang = 'IF_106';

INSERT INTO jadwal (ruangan_kelas_id, hari, jam_mulai, jam_selesai, mata_kuliah)
  SELECT id, 'Jumat', '15:30:00', '18:20:00', 'S3_TD MPPL'
  FROM ruangan_kelas WHERE nama_ruang = 'IF_106';

INSERT INTO jadwal (ruangan_kelas_id, hari, jam_mulai, jam_selesai, mata_kuliah)
  SELECT id, 'Senin', '10:00:00', '12:50:00', 'IF_Text Mining T'
  FROM ruangan_kelas WHERE nama_ruang = 'IF_107';
...
INSERT INTO jadwal (ruangan_kelas_id, hari, jam_mulai, jam_selesai, mata_kuliah)
  SELECT id, 'Jumat', '13:30:00', '16:20:00', 'IF_Desain Pengalaman Pengguna T (EN)'
  FROM ruangan_kelas WHERE nama_ruang = 'IF_107';

INSERT INTO jadwal (ruangan_kelas_id, hari, jam_mulai, jam_selesai, mata_kuliah)
  SELECT id, 'Senin', '07:00:00', '09:50:00', 'IF_Animasi Komputer dan Pemodelan 3D T'
  FROM ruangan_kelas WHERE nama_ruang = 'IF_108';
...
INSERT INTO jadwal (ruangan_kelas_id, hari, jam_mulai, jam_selesai, mata_kuliah)
  SELECT id, 'Jumat', '09:00:00', '11:50:00', 'IUP_Komputasi Numerik IUP I'
  FROM ruangan_kelas WHERE nama_ruang = 'IF_108';

INSERT INTO jadwal (ruangan_kelas_id, hari, jam_mulai, jam_selesai, mata_kuliah)
  SELECT id, 'Senin', '07:00:00', '09:50:00', 'RPL_Interaksi Manusia dan Komputer M (EN)'
  FROM ruangan_kelas WHERE nama_ruang = 'IF_113';
...
INSERT INTO jadwal (ruangan_kelas_id, hari, jam_mulai, jam_selesai, mata_kuliah)
  SELECT id, 'Kamis', '18:30:00', '19:20:00', 'Topik Dalam Algoritma dan Teknik Optimasi P'
  FROM ruangan_kelas WHERE nama_ruang = 'IF_113';

INSERT INTO jadwal (ruangan_kelas_id, hari, jam_mulai, jam_selesai, mata_kuliah)
  SELECT id, 'Jumat', '18:30:00', '19:20:00', 'Topik Dalam Rekayasa Kebutuhan P'
  FROM ruangan_kelas WHERE nama_ruang = 'IF_113';

INSERT INTO jadwal (ruangan_kelas_id, hari, jam_mulai, jam_selesai, mata_kuliah)
  SELECT id, 'Senin', '07:00:00', '09:50:00', 'IF_Perancangan Perangkat Lunak E'
  FROM ruangan_kelas WHERE nama_ruang = 'LP_1';
...
INSERT INTO jadwal (ruangan_kelas_id, hari, jam_mulai, jam_selesai, mata_kuliah)
  ...
  FROM ruangan_kelas WHERE nama_ruang = 'LP_2';
...
INSERT INTO jadwal (ruangan_kelas_id, hari, jam_mulai, jam_selesai, mata_kuliah)
  ...
  FROM ruangan_kelas WHERE nama_ruang = 'Netics';
...
INSERT INTO jadwal (ruangan_kelas_id, hari, jam_mulai, jam_selesai, mata_kuliah)
  SELECT id, 'Jumat', '09:00:00', '11:50:00', 'IF_Aljabar Linier R'
  FROM ruangan_kelas WHERE nama_ruang = 'Netics';

INSERT INTO jadwal (ruangan_kelas_id, hari, jam_mulai, jam_selesai, mata_kuliah)
  SELECT id, 'Jumat', '13:30:00', '16:20:00', 'IF_Sistem Digital R'
  FROM ruangan_kelas WHERE nama_ruang = 'Netics';

INSERT INTO jadwal (ruangan_kelas_id, hari, jam_mulai, jam_selesai, mata_kuliah)
  SELECT id, 'Jumat', '13:30:00', '15:20:00', 'IF, RKA, & IUP_Etika Profesi A'
  FROM ruangan_kelas WHERE nama_ruang = 'Aula Handayani';